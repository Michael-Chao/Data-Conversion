...
# 定义输入和输出路径
input_dir = r'D:\Project\Convert_Dataset\轨迹预测数据\0509数据\降落\5_out3'
train_dir = r'D:\Project\Convert_Dataset\轨迹预测数据\0509数据\降落\6_train'

# 定义起飞和降落文件夹索引
takeoff = [0, 2, 4, 7, 10, 12, 14, 17]
landing = [1, 3, 5, 6, 8, 9, 11, 13, 15, 16, 18, 19, 21, 22, 24, 25, 26, 27]
...
adsb_contents = ['20220701_1', '20220701_2', '20220701_3', '20220701_4',
                 ...
                 '20220708_1', '20220708_2', '20220708_3', '20220708_4',
                 '20220710_1', '20220710_2', '20220710_4',
                 '20220711_2', '20220711_4',
                 '20220713_2',
                 '20220715_2',
                 '20220718_4',
                 '20220719_2',
...
for folder_name in adsb_contents:
    ...
    if not os.path.exists(input_folder_path):
        print(f"文件夹 {input_folder_path} 不存在，跳过。")
        continue
