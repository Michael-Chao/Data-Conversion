...
def process_file(file_path, data_points_per_group, skip_points):
    """
    读取.csv文件的数据，并按指定数量的数据进行采集，并跳过指定数量的数据点。
...
def main():
    # 输入路径、输出路径和每组数据点的数量
    input_dir = r'D:\Project\Convert_Dataset\轨迹预测数据\0509数据\降落\4_out2'
    output_dir = r'D:\Project\Convert_Dataset\轨迹预测数据\0509数据\降落\5_out3'
